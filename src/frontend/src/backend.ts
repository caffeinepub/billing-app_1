...
import type { CustomerDetails as _CustomerDetails, Invoice as _Invoice, LineItem as _LineItem, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createInvoice(arg0: string, arg1: CustomerDetails, arg2: Array<LineItem>, arg3: bigint, arg4: string): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async getInvoice(arg0: bigint): Promise<Invoice> {
        if (this.processError) {
            try {
                ...
                return from_candid_Invoice_n13(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async updateInvoice(arg0: bigint, arg1: string, arg2: CustomerDetails, arg3: Array<LineItem>, arg4: bigint, arg5: string, arg6: Variant_finalized_draft): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateInvoice(arg0, arg1, arg2, arg3, arg4, arg5, to_candid_variant_n17(this._uploadFile, this._downloadFile, arg6));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_variant_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    draft: null;
}): Variant_finalized_draft {
    return "finalized" in value ? Variant_finalized_draft.finalized : "draft" in value ? Variant_finalized_draft.draft : value;
}
...
function to_candid_variant_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Variant_finalized_draft): {
    finalized: null;
} | {
    draft: null;
} {
    return value == Variant_finalized_draft.finalized ? {
        finalized: null
    } : value == Variant_finalized_draft.draft ? {
        draft: null
    } : value;
}
